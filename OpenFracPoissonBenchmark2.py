...
Solution is computed on a large mesh with gmres/amg solver
"""
...
# These do not seem to do anything right now
...
# Solve
u = Function(V)
solve(a == L, u, bc, solver_parameters={"linear_solver" : "iterative", "preconditioner" : "ml_amg"})
